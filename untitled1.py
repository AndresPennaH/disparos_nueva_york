# -*- coding: utf-8 -*-
"""
Created on Thu Mar 17 16:35:31 2022
...
st.markdown("<h1 style ='text-align: center; color: #C807FC;'>Histórico de disparos en Nueva York 🗽 </h1>", unsafe_allow_html =True)
...
##############################################################################
c4.markdown("<h3 style ='text-align: center; color:white;'>Top Barrio</h3>", unsafe_allow_html =True)
...
st.markdown("<h3 style ='text-align: center; color: white;'>¿Cómo ha sido la evolución de disparos por barrio en Nueva York? </h3>", unsafe_allow_html =True)
...
fig = px.bar(df2, x='disparos', y='perp_age_group', orientation ='h', width=340, height =370)
...
c5.markdown("<h3 style ='text-align: center; color: white;'>¿Qué edad tienen las victimas?</h3>", unsafe_allow_html =True)
...
fig = px.bar(df2, x='disparos', y='vic_age_group', orientation ='h', width=340, height =370)
...
c7.markdown("<h3 style ='text-align: center; color: white;'>¿Cuál es el sexo de la victima?</h3>", unsafe_allow_html =True)
...
fig = px. bar(df2, x ='year', y ='incident_key', color ='hour', barmode='group', width =1250, height=450)
